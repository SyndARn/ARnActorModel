...
namespace Actor.Base
{
    public static class BaseActorExtension
    {
        ...
        {
            CheckArg.Actor(anActor);
            return anActor.ReceiveAsync((o) => o is IMessageParam<T1, T2> t && aPattern(t.Item1, t.Item2));
        }
        ...
        public static Task<object> ReceiveAsync<T1, T2, T3, T4>(this BaseActor anActor, Func<T1, T2, T3, T4, bool> aPattern)
        {
            CheckArg.Actor(anActor);
            return anActor.ReceiveAsync((o) => o is IMessageParam<T1, T2, T3, T4> t && aPattern(t.Item1, t.Item2, t.Item3, t.Item4));
        }
    }
}
